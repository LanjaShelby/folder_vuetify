                       ...
                       <!--  
                              ...
                              <div class="d-flex justify-space-around " style="padding:20px;">
                                ...
                                <v-badge
                                  ...
                                  >
                                <v-btn  color="primary"  @click ="replyMessage(Message)"
                                >
                                  <v-icon icon="mdi mdi-message-reply-text-outline" ></v-icon> 
                                  </v-btn> 
                             </v-badge>
                              <v-btn  v-else color="primary"  @click ="replyMessage(Message)" >
                              <v-icon icon="mdi mdi-message-reply-text-outline" ></v-icon> 
                              </v-btn>
    ...
    const formData = new FormData();
      ...
      async  GetMessages(){
       ...
       subscriberMercure(){
          ...
          const hubUrl = 'http://localhost:5000/.well-known/mercure';
