        ...
        <v-card-text>
          ...
          ref="fichier"
            ...
            @change="calculsize"
              ...
              <div> taille total = {{totalsize}}</div>
            </v-file-input>
                  ...
                  .then((response) => {
                    ...
                    .catch((error) => {
                      ...
                      if (error.response) {
                        ...
                        this.isFailed= true;
                        this.errorMessages =   "Elapsed Time : Automatic disconnected account";
                      } else {
                        console.error('Erreur lors de l\'envoi:', error.message);
                        this.isFailed = true;
                        this.errorMessages =   "Failed to send request";
                      }  });
